...
namespace Euro2024Stat.PlayerAPI.Extensions
{
                ...
                option.AddSecurityRequirement(new OpenApiSecurityRequirement
    {
        ...
        public static void RegisterPlayerService(this IServiceCollection service)
        {
            service.AddScoped<IPlayer, PlayerService>();
        }
