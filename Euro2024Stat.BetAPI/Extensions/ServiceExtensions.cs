...
namespace Euro2024Stat.BetAPI.Extensions
{
    public static class ServiceExtensions
    {
        ...
        public static void RegisterPublicBetService(this IServiceCollection service)
        {
            service.AddScoped<IPublicBet, PublicBetService>();
        }

        public static void RegisterPrivateBetService(this IServiceCollection service)
        {
            service.AddScoped<IPrivateBet, PrivateBetService>();
        }
