...
namespace Euro2024Stat.WalletAPI.Extensions
{
    public static class ServiceExtensions
    {
        ...
        public static void RegisterWalletService(this IServiceCollection service)
        {
            service.AddScoped<IWallet, WalletService>();
        }
