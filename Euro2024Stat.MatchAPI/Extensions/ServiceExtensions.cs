...
namespace Euro2024Stat.MatchAPI.Extensions
{
                ...
                option.AddSecurityRequirement(new OpenApiSecurityRequirement
    {
        ...
        public static void RegisterPublicMatchService(this IServiceCollection service)
        {
            service.AddScoped<IPublicMatch, PublicMatchService>();
        }

        public static void RegisterPrivateMatchService(this IServiceCollection service)
        {
            service.AddScoped<IPrivateMatch, PrivateMatchService>();
        }
